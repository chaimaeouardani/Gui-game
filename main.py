...
# mainloop
bullets = [ ]
man = player(450, 525, 64, 64)


goblin2 = enemy(700, 540, 200, 200, screenx - 200)
goblin = enemy(100, 540, 200, 200, screenx - 200)
...
while run:
        ...
        if bullet.y - bullet.radius < goblin.hitbox[1] + goblin.hitbox[3] and bullet.y + bullet.radius > goblin.hitbox[
            ...
            if bullet.y - bullet.radius < goblin2.hitbox[1] + goblin2.hitbox[3] and bullet.y + bullet.radius > \
                ...
                if bullet.x + bullet.radius > goblin2.hitbox[0] and bullet.x - bullet.radius < goblin2.hitbox[0] + \
                    ...
                    score += 1
                    bullets.pop(bullets.index(bullet))
        if bullet.x < screenx and bullet.x > 0:
             bullet.x += bullet.vel
        else:
            bullets.pop(bullets.index(bullet))
    ...
    elif keys[pygame.K_RIGHT] and man.x < screenx - man.width - man.vel:
        man.x += man.vel
        man.right = True
        man.left = False
        man.standing = False
